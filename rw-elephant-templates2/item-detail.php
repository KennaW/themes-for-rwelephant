<div id="rwe-gallery">
	...
	<div class="rwe-sidebox">
		...
		<div class="rwe-description">
			...
			<p id="item-price" data-category="[item_category_name]">
				<span class="rwe-desc-label">Rental price:</span> $[item_price]
			</p>
		</div>
		...
		<ul id="rwe-recommend" data-item="[item_id]"><!-- recommended items --></ul>
